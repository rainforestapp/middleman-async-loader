...
class Middleman::AsyncLoader < Middleman::Extension
  helpers do
    ...
    def bootstrap
      ...
      @has_loaded = true
      "window.___asl=function(t,f,wf,i,c){var d=document,e=d.createElement(t=='css'?'link':'script');e[t=='css'?'href':'src']=f;e[t=='css'?'rel':'type']=t=='css'?'stylesheet':'text/javascript';if(wf){e.rel='subresource'};e.integrity=i;if(c !== false){e.crossOrigin=c};d.body.appendChild(e);return e;};"
    end
  end
end
